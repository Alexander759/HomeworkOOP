...
int main() {
	...
	//User admin("admin", "", "password", adminList);
	...
	//
	//Command addToCourse("add_to_course", "",
	...
	//Command viewAssignmentSubmissions("view_assignment_submissions", "",
